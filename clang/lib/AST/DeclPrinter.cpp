...
namespace {
  class DeclPrinter : public DeclVisitor<DeclPrinter> {
    ...
    void PrintVptrInsertorInitializers(VptrInsertorDecl *CDecl,
                                      std::string &Proto);
...
void DeclPrinter::PrintVptrInsertorInitializers(VptrInsertorDecl *CDecl,
                                               std::string &Proto) {
...
void DeclPrinter::VisitFunctionDecl(FunctionDecl *D) {
  ...
  VptrInsertorDecl *VDecl = dyn_cast<VptrInsertorDecl>(D);
  ...
  if (const FunctionType *AFT = Ty->getAs<FunctionType>()) {
    ...
    if (CDecl) {
      ...
      if (!Policy.TerseOutput)
        PrintVptrInsertorInitializers(VDecl, Proto);
