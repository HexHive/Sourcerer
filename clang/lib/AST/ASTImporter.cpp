...
#include "clang/AST/TypeNodes.inc"
    ...
    ExpectedStmt VisitVptrInsertorExpr(VptrInsertorExpr *E);
...
ExpectedStmt ASTNodeImporter::VisitVptrInsertorExpr(VptrInsertorExpr *E) {
  Error Err = Error::success();
  auto ToType = importChecked(Err, E->getType());
  auto ToLocation = importChecked(Err, E->getLocation());
  auto ToConstructor = importChecked(Err, E->getConstructor());
  ...
  return VptrInsertorExpr::Create(
