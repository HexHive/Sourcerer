...
#include "clang/AST/TypeNodes.inc"
  ...
  void mangleVptrInsertorType(CXXCtorType T, const CXXRecordDecl *InheritedFrom);
...
void CXXNameMangler::mangleUnqualifiedName(
  ...
  case DeclarationName::Identifier: {
    ...
    if(const VptrInsertorDecl *VD = dyn_cast<VptrInsertorDecl>(ND)) {

    const CXXRecordDecl *InheritedFrom = nullptr;
    TemplateName InheritedTemplateName;
    const TemplateArgumentList *InheritedTemplateArgs = nullptr;
      if (auto  Inherited=
              cast<VptrInsertorDecl>(ND)->getInheritedVptrInsertor()) {
      ...
      if (ND == Structor)
        ...
        // we were given.
        mangleVptrInsertorType(static_cast<CXXCtorType>(StructorType), InheritedFrom);
      else
        // Otherwise, use the complete constructor name. This is relevant if a
        // class with a constructor is declared within a constructor.
        mangleVptrInsertorType(Ctor_Complete, InheritedFrom);
      break;
    }
...
void CXXNameMangler::mangleVptrInsertorType(CXXCtorType T,
                                       const CXXRecordDecl *InheritedFrom) {
  // <ctor-dtor-name> ::= C1  # complete object constructor
  //                  ::= C2  # base object constructor
  //                  ::= CI1 <type> # complete inheriting constructor
...
void ItaniumMangleContextImpl::mangleCXXName(GlobalDecl GD,
  ...
  if (auto *CD = dyn_cast<VptrInsertorDecl>(D)) {
