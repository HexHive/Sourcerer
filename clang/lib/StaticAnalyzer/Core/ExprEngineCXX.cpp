...
void ExprEngine::handleVptrInsertor(const Expr *E,
                                   ExplodedNode *Pred,
                                   ExplodedNodeSet &destNodes) {
  const auto *CE = dyn_cast<VptrInsertorExpr>(E);
  ...
  CallEventRef<> Call =
      CIE ? (CallEventRef<>)CEMgr.getCXXInheritedConstructorCall(
          ...
          : (CallEventRef<>)CEMgr.getVptrInsertorCall(
...
void ExprEngine::VisitVptrInsertorExpr(const VptrInsertorExpr *CE,
                                       ExplodedNode *Pred,
                                       ExplodedNodeSet &Dst) {
  handleVptrInsertor(CE, Pred, Dst);
}
