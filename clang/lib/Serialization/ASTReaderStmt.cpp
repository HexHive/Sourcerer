...
void ASTStmtReader::VisitVptrInsertorExpr(VptrInsertorExpr *E) {
  VisitExpr(E);
  ...
  E->Constructor = readDeclAs<VptrInsertorDecl>();
...
Stmt *ASTReader::ReadStmtFromStream(ModuleFile &F) {
  ...
  while (true) {
    ...
    case EXPR_CXX_CONSTRUCT:
      ...
      break;
    case EXPR_VPTR_INSERTOR:
      S = VptrInsertorExpr::CreateEmpty(
          Context,
          /* NumArgs=*/Record[ASTStmtReader::NumExprFields]);
      break;
