...
public:
  ...
  void VisitVptrInsertorExpr(const VptrInsertorExpr *Exp);
...
void BuildLockset::VisitVptrInsertorExpr(const VptrInsertorExpr *Exp) {
  const VptrInsertorDecl *D = Exp->getConstructor();
