...
public:
  ...
  void VisitVptrInsertorExpr(const VptrInsertorExpr *Call);
...
void ConsumedStmtVisitor::VisitVptrInsertorExpr(const VptrInsertorExpr *Call) {
  VptrInsertorDecl *Constructor = Call->getConstructor();
