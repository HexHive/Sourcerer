...
public:
  ...
  bool inheritingCtorHasParams(const InheritedConstructor &Inherited,
                               CXXCtorType Type);
  bool inheritingVptrInsertorHasParams(const InheritedVptrInsertor &Inherited,
                               CXXCtorType Type);
  ...
  const CGFunctionInfo &arrangeVptrInsertorDeclaration(GlobalDecl GD);
  const CGFunctionInfo &arrangeCXXStructorDeclaration(GlobalDecl GD);
  const CGFunctionInfo &arrangeCXXVptrInsertorCall(const CallArgList &Args,
