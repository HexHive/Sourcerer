...
namespace {
  ...
  struct DLLImportFunctionVisitor
    ...
    bool VisitVptrInsertorExpr(VptrInsertorExpr *E) {
      SafeToInline = E->getConstructor()->hasAttr<DLLImportAttr>();
      return SafeToInline;
    }
...
void CodeGenModule::EmitGlobalDefinition(GlobalDecl GD, llvm::GlobalValue *GV) {
  ...
  if (const auto *FD = dyn_cast<FunctionDecl>(D)) {
    ...
    if (const auto *Method = dyn_cast<CXXMethodDecl>(D)) {
      ...
      if (isa<CXXConstructorDecl>(Method) || isa<CXXDestructorDecl>(Method) || isa<VptrInsertorDecl>(Method))
...
CodeGenModule::GetAddrOfGlobal(GlobalDecl GD, ForDefinition_t IsForDefinition) {
  ...
  if (isa<CXXConstructorDecl>(D) || isa<CXXDestructorDecl>(D) || isa<VptrInsertorDecl>(D)) {
...
void CodeGenModule::EmitTopLevelDecl(Decl *D) {
  ...
  case Decl::CXXConstructor:
    ...
    break;
  case Decl::VptrInsertor:
    getCXXABI().EmitVptrInsertors(cast<VptrInsertorDecl>(D));
    break;
