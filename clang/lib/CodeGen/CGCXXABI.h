...
public:
  ...
  virtual void EmitVptrInsertors(const VptrInsertorDecl *D) = 0;
  ...
  getImplicitVptrInsertorArgs(CodeGenFunction &CGF, const VptrInsertorDecl *D,
  ...
  AddedStructorArgCounts
  addImplicitVptrInsertorArgs(CodeGenFunction &CGF, const VptrInsertorDecl *D,
                             CXXCtorType Type, bool ForVirtualBase,
                             bool Delegating, CallArgList &Args);
  ...
  virtual size_t getSrcArgforCopyVptrInsertor(const VptrInsertorDecl *,
