...
public:
  ...
  llvm::Constant *
  getAddrOfVptrInsertor(GlobalDecl GD, const CGFunctionInfo *FnInfo = nullptr,
                       llvm::FunctionType *FnType = nullptr,
                       bool DontDefer = false,
                       ForDefinition_t IsForDefinition = NotForDefinition) {
    return cast<llvm::Constant>(getAddrAndTypeOfVptrInsertor(GD, FnInfo, FnType,
                                                            DontDefer,
                                                            IsForDefinition)
                                    .getCallee());
  }
  ...
  llvm::FunctionCallee getAddrAndTypeOfVptrInsertor(
