...
public:
  ...
  static bool IsVptrInsertorDelegationValid(const VptrInsertorDecl *Ctor);

  void EmitConstructorBody(FunctionArgList &Args);
  void EmitVptrInsertorBody(FunctionArgList &Args);
  ...
  void EmitVptrInsertorPrologue(const VptrInsertorDecl *CD, CXXCtorType Type,
                        FunctionArgList &Args);
...
public:
  ...
  llvm::Value *GetVTTParameter(GlobalDecl GD, bool ForVirtualBase,
                               bool Delegating);
  void EmitDelegateVptrInsertorCall(const VptrInsertorDecl *Ctor,
  ...
  void EmitDelegatingCXXVptrInsertorCall(const VptrInsertorDecl *Ctor,
                                        const FunctionArgList &Args);
  ...
  void EmitInlinedInheritingCXXConstructorCall(const CXXConstructorDecl *Ctor,
                                               ...
                                               bool Delegating,
                                               CallArgList &Args);
  void EmitInlinedInheritingCXXVptrInsertorCall(const VptrInsertorDecl *Ctor,
                                               CXXCtorType CtorType,
                                               bool ForVirtualBase,
                                               bool Delegating,
                                               CallArgList &Args);
  ...
  void EmitVptrInsertorCall(const VptrInsertorDecl *D, CXXCtorType Type,
                              bool ForVirtualBase, bool Delegating,
                              AggValueSlot ThisAVS, const VptrInsertorExpr *E);
  ...
  void EmitCXXAggrVptrInsertorCall(const VptrInsertorDecl *D,
...
public:
  ...
  static bool isRealloc(std::string fun_name, std::string class_name);
  ...
  void InsertVptrForUnion(Address Addr, CXXRecordDecl* Parent, CXXRecordDecl* Child, Expr* E);
  ...
  void EmitVptrInsertorExpr(const VptrInsertorExpr *E, AggValueSlot Dest);
