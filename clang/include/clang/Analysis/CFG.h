...
class CFGVptrInsertor : public CFGStmt {
public:
  explicit CFGVptrInsertor(VptrInsertorExpr *CE, const ConstructionContext *C)
      : CFGStmt(CE, Constructor) {
    assert(C);
    Data2.setPointer(const_cast<ConstructionContext *>(C));
  }
...
public:
  ...
  void appendVptrInsertor(VptrInsertorExpr *CE, const ConstructionContext *CC,
                         BumpVectorContext &C) {
    Elements.push_back(CFGVptrInsertor(CE, CC), C);
  }
