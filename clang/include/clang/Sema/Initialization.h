...
public:
  ...
  static InitializationKind CreateVptr(SourceLocation InitLoc) {
    return InitializationKind(IK_Vptr, IC_Normal, InitLoc, InitLoc, InitLoc);
  }
...
public:
  ...
  InitializationSequence(Sema &S,
                         ...
                         bool TreatUnavailableAsInvalid = true, int vptrInsertor = 0);
  void InitializeVptrInsertorFrom(Sema &S, const InitializedEntity &Entity,
  ...
  void AddVptrInsertorInitializationStep(DeclAccessPair FoundDecl,
