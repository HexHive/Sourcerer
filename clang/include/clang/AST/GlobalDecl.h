...
public:
  ...
  GlobalDecl(const VptrInsertorDecl *D, CXXCtorType Type) : Value(D, Type) {}
  ...
  CXXCtorType getCtorType() const {
    assert(isa<CXXConstructorDecl>(getDecl()) || isa<VptrInsertorDecl>(getDecl()) && "Decl is not a ctor!");
    return static_cast<CXXCtorType>(Value.getInt());
  }
  CXXCtorType getVptrInsertorType() const {
    assert(isa<VptrInsertorDecl>(getDecl()) && "Decl is not a ctor!");
    return static_cast<CXXCtorType>(Value.getInt());
  }
  ...
  GlobalDecl getWithCtorType(CXXCtorType Type) {
    assert(isa<CXXConstructorDecl>(getDecl()) || isa<VptrInsertorDecl>(getDecl()));
    GlobalDecl Result(*this);
