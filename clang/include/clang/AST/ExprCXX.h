...
class VptrInsertorExpr : public Expr {
  friend class ASTStmtReader;
...
protected:
  ...
  VptrInsertorExpr(StmtClass SC, QualType Ty, SourceLocation Loc,
                   VptrInsertorDecl *Ctor, bool Elidable, 
  ...
  VptrInsertorExpr(StmtClass SC, EmptyShell Empty, unsigned NumArgs);
...
public:
  ...
  const Stmt *const *getTrailingArgs() const {
    return const_cast<VptrInsertorExpr *>(this)->getTrailingArgs();
  }

  /// Create a C++ construction expression.
  static VptrInsertorExpr *
  Create(const ASTContext &Ctx, QualType Ty, SourceLocation Loc,
         VptrInsertorDecl *Ctor, bool Elidable, ArrayRef<Expr *> Args,
         bool HadMultipleCandidates, bool ListInitialization,
         bool StdInitListInitialization, bool ZeroInitialization,
         CXXConstructionKind ConstructKind, SourceRange ParenOrBraceRange);

  /// Create an empty C++ construction expression.
  static VptrInsertorExpr *CreateEmpty(const ASTContext &Ctx, unsigned NumArgs);

  /// Get the constructor that this expression will (ultimately) call.
  VptrInsertorDecl *getConstructor() const { return Constructor; }

  SourceLocation getLocation() const { return VptrInsertorExprBits.Loc; }
  void setLocation(SourceLocation Loc) { VptrInsertorExprBits.Loc = Loc; }

  /// Whether this construction is elidable.
  bool isElidable() const { return VptrInsertorExprBits.Elidable; }
  void setElidable(bool E) { VptrInsertorExprBits.Elidable = E; }

  /// Whether the referred constructor was resolved from
  /// an overloaded set having size greater than 1.
  bool hadMultipleCandidates() const {
    return VptrInsertorExprBits.HadMultipleCandidates;
  }
  void setHadMultipleCandidates(bool V) {
    VptrInsertorExprBits.HadMultipleCandidates = V;
  }

  /// Whether this constructor call was written as list-initialization.
  bool isListInitialization() const {
    return VptrInsertorExprBits.ListInitialization;
  }
  void setListInitialization(bool V) {
    VptrInsertorExprBits.ListInitialization = V;
  }
  ...
  bool isStdInitListInitialization() const {
    return VptrInsertorExprBits.StdInitListInitialization;
  }
  void setStdInitListInitialization(bool V) {
    VptrInsertorExprBits.StdInitListInitialization = V;
  }

  /// Whether this construction first requires
  /// zero-initialization before the initializer is called.
  bool requiresZeroInitialization() const {
    return VptrInsertorExprBits.ZeroInitialization;
  }
  void setRequiresZeroInitialization(bool ZeroInit) {
    VptrInsertorExprBits.ZeroInitialization = ZeroInit;
  }
  ...
  CXXConstructionKind getConstructionKind() const {
    return static_cast<CXXConstructionKind>(
        VptrInsertorExprBits.ConstructionKind);
  }
  void setConstructionKind(CXXConstructionKind CK) {
    VptrInsertorExprBits.ConstructionKind = llvm::to_underlying(CK);
  }
  ...
  static bool classof(const Stmt *T) {
    return T->getStmtClass() == VptrInsertorExprClass ||
  ...
  const_child_range children() const {
    auto Children = const_cast<VptrInsertorExpr *>(this)->children();
    return const_child_range(Children.begin(), Children.end());
  }
};
...
Stmt **VptrInsertorExpr::getTrailingArgs() {
  assert((getStmtClass() == VptrInsertorExprClass) &&
