...
public:
  ...
  enum NameKind {
    ...
    VptrInsertorName = StoredVptrInsertorName,
...
private:
  ...
  DeclarationName(detail::CXXSpecialNameExtra *Name,
                  StoredNameKind StoredKind, bool vptrInsertorArg=false) {
    assert((StoredKind == StoredCXXConstructorName ||
           StoredKind == StoredVptrInsertorName ||
    ...
    if (StoredKind == StoredCXXConstructorName) {
      vptrInsertor = vptrInsertorArg;
    }
  ...
  detail::CXXSpecialNameExtra *castAsCXXSpecialNameExtra() const {
    assert((getStoredNameKind() == StoredCXXConstructorName ||
           getStoredNameKind() == StoredVptrInsertorName ||
...
class DeclarationNameTable {
  ...
  llvm::FoldingSet<detail::CXXSpecialNameExtra> CXXVptrInsertorNames;
...
public:
  ...
  DeclarationName getVptrInsertorName(CanQualType Ty);
...
public:
  ...
  TypeSourceInfo *getNamedTypeInfo() const {
    if (Name.getNameKind() != DeclarationName::CXXConstructorName &&
           Name.getNameKind() != DeclarationName::VptrInsertorName &&
